...
next-app
```
(Since your Next.js app is in a subdirectory)
...
| `SENDGRID_FROM` | `noreply@lacqueandlatte.ca` | Production |
| `SENDGRID_TO` | `info@lacqueandlatte.ca` | Production |
